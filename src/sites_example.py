      ...
      while True:
        ...
        if choice == 1:
          ...
          new_entry = self.client.CreatePage(
              'webpage', page_title, '''
<div>
<div style="display:inline;margin:5px 10px 0px 0px;float:left"><a href="http://www.scribd.com/doc/98794600/Folkstyre-eller-Fogdevalde-av-Gunnar-Lundberg" imageanchor="1"><img border="0" src="https://sites.google.com/site/motargumentwiki/home/olofs-leksida/testbok/Folkstyre%20eller%20fogdev%C3%A4lde.png"></a></div>
</div>
<div><a href="http://www.scribd.com/doc/98794600/Folkstyre-eller-Fogdevalde-av-Gunnar-Lundberg">"</a>Folkstyre eller fogdevälde",&nbsp;av Gunnar Lundberg.</div>
<div>Utgivning: förlaget Tiden, tryckt i Stockholm 1934.</div>
<div>Antal sidor: 24.</div>
<div><br>
</div>
<div>Bilderna har kopierats &amp; klippts ut härifrån:&nbsp;<a href="http://www.scribd.com/doc/98794600/Folkstyre-eller-Fogdevalde-av-Gunnar-Lundberg" target="_blank">Scribd.com-länk.</a></div>
<div><br>
</div>
<div><i>Notera: om du vill läsa boken är Scribd att föredra. Där kan du även ladda ned hela saken i PDF-format för kopiering till mobiltelefon eller surfplatta. Här på wikin är det transkribering &amp; sökning som är prioriterat - inte läsupplevelse!</i></div>
<table border="1" bordercolor="#888" cellspacing="0" style="border-collapse:collapse;border-color:rgb(136,136,136);border-width:1px">
<tbody>
<tr>
<td style="width:58px;height:15px">&nbsp;Sida</td>
<td style="width:88px;height:15px">Status&nbsp;</td>
</tr>
<tr>
<td style="width:58px;height:15px">&nbsp;<a href="https://sites.google.com/site/motargumentwiki/home/olofs-leksida/testbok/test">3</a></td>
<td style="width:88px;height:15px"><span style="background-color:rgb(0,255,0)">Transkriberad, ej granskad&nbsp;<br>
</span></td>
</tr>
<tr>
<td style="width:58px;height:15px">&nbsp;<a href="https://sites.google.com/site/motargumentwiki/home/olofs-leksida/testbok/testbok-sida-2">4</a></td>
<td style="width:88px;height:15px"><span style="background-color:rgb(0,255,0)">Transkriberad, ej granskad</span></td>
</tr>
<tr>
<td style="width:58px;height:15px">&nbsp;<a href="https://sites.google.com/site/motargumentwiki/home/olofs-leksida/testbok/testbok-sida-3">5</a></td>
<td style="width:88px;height:15px"><span style="background-color:rgb(0,255,0)">Transkriberad, ej granskad</span>
</td>
</tr>
<tr>
<td style="width:58px;height:15px"><span style="background-color:rgb(255,255,255)">&nbsp;6</span></td>
<td style="width:88px;height:15px"><span style="background-color:rgb(255,0,0)">Saknas&nbsp;</span></td>
</tr>
<tr>
<td style="width:58px;height:15px"><span style="background-color:rgb(255,255,255)">&nbsp;</span>7</td>
<td style="width:88px;height:15px"><span style="background-color:rgb(255,0,0)">Saknas&nbsp;</span></td>
</tr>
</tbody>
</table>
